...
const PWR = Planet.planetsWithRings([
  myPlanet1, myPlanet2, myPlanet3, myPlanet4,
  myPlanet5, myPlanet6, myPlanet7, myPlanet8
]);

// Distancia entre Venus y Saturno
const venusToSarturn = Planet.distanceBetweenPlanets(
  myPlanet2,
  myPlanet6
);
